...
The app developed for the first part of the assignment demo is avalilable at: https://mehdighm.shinyapps.io/CourseProjectShinyApplicationandReproduciblePitch/

Source code for ui.R and server.R files are available on the GitHub repo: https://github.com/mgmoghadam/Course-Project-Shiny-Application-and-Reproducible-Pitch/
...
library(car)
scatterplot.matrix(~mpg + hp , data = mtcars)
```
